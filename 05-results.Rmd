...
> There is a new category in post-COVID era called "Hate Crime". How does hate crimes distributed on the geometry dimension?
...
> We first analyzed Arrest Data

> Then Complaint Data

> Then Hate Crime Data.
...
* The most important pattern is, staring 2013, a consecutive decreasing in Violation happened. If we regard the actual arrests as actual happened crimes, the social security powers have successfully rooted violation.

* Both felony and misdemeanor displayed a relatively stable range before 2014. Staring 2015, both of the ratios entered a decreasing period. The misdemeanor ratio implies a bigger gap between arrests and complains. 

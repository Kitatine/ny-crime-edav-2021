...
For the time span part, we first perform a time analysis on the categories of different level of offense crime (felony, misdemeanor, violation, and other) of crimes on the whole time span (from 2005 to 2020); then we 
